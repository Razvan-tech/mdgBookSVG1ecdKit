...
#===================================================================================
#
#	 FILE:	mdgecd2midRndN+svg.sh
#
#	USAGE:	mdgecd2midRndN+svg.sh <num>
#
...
#		minuet based on the rules given K.Anh.C 30.01 (1792/93 publication attributed to 
#		W.A. Mozart by his publisher, Nikolaus Simrock), and the corresponding MIDI files.  
#
#      AUTHOR:	J.L.A. Uro (justineuro@gmail.com)
#     VERSION:	0.0.0
#     LICENSE:	Creative Commons Attribution 4.0 International License (CC-BY)
#     CREATED:	2025/05/19 11:27:24
#    REVISION:	
#==================================================================================
